...
_$AllowanceModelImpl _$$AllowanceModelImplFromJson(Map<String, dynamic> json) =>
    _$AllowanceModelImpl(
      ...
      allowanceDateMs: (json['allowanceDateMs'] as num).toInt(),
...
Map<String, dynamic> _$$AllowanceModelImplToJson(
        _$AllowanceModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'allowanceDateMs': instance.allowanceDateMs,
