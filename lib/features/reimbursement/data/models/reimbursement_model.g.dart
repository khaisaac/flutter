...
_$ReimbursementModelImpl _$$ReimbursementModelImplFromJson(
    ...
    _$ReimbursementModelImpl(
      ...
      description: json['description'] as String? ?? '',
      linkedCashAdvanceId: json['linkedCashAdvanceId'] as String?,
      linkedCashAdvancePurpose: json['linkedCashAdvancePurpose'] as String?,
...
Map<String, dynamic> _$$ReimbursementModelImplToJson(
    ...
    <String, dynamic>{
      ...
      'description': instance.description,
      'linkedCashAdvanceId': instance.linkedCashAdvanceId,
      'linkedCashAdvancePurpose': instance.linkedCashAdvancePurpose,
