...
class ReimbursementModel with _$ReimbursementModel {
  ...
  Map<String, dynamic> toFirestore() => {
        ...
        'currency': currency,
        'description': description,
        'linkedCashAdvanceId': linkedCashAdvanceId,
        'linkedCashAdvancePurpose': linkedCashAdvancePurpose,
        'status': status,
        'picUid': picUid,
  ...
  factory ReimbursementModel.fromEntity(ReimbursementEntity e) =>
      ReimbursementModel(
        ...
        currency: e.currency,
        description: e.description,
        linkedCashAdvanceId: e.linkedCashAdvanceId,
        linkedCashAdvancePurpose: e.linkedCashAdvancePurpose,
